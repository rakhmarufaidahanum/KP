                ...
                <div class="col-lg-12">                           
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Insert Material ID</h3>
                    </div>
                    <div class="card-body">
                      <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">Material</label>
                          <input id="inlineFormInput" type="text" placeholder="Material ID" class="mr-3 form-control">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">Date</label>
                          <input id="inlineFormInputGroup" type="text" placeholder="Start" class="mr-3 form-control">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">Date</label>
                          <input id="inlineFormInputGroup" type="text" placeholder="End" class="mr-3 form-control">
                        </div>
                        <div class="form-group">
